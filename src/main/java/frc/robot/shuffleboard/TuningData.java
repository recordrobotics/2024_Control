...
/**
 * Used for tuning using shuffleboard (contains the current value and target of
 * whatever you are trying to tune)
 * For example can be used for motor PID tuning, velocity tuning, feed forward
 * tuning, etc.
 */
