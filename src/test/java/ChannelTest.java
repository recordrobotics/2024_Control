...
public class ChannelTest {
    ...
    public void testToggleThroughState() {
        ...
        assertEquals(Constants.Channel.THROUGH_SPEED, motorSim.getSpeed(), TOLERANCE, "Motor should be set to default THROUGH speed.");
    }

    @Test
    public void testToggleReverseState() {
        channel.toggle(Channel.ChannelStates.REVERSE);
        assertEquals(Constants.Channel.REVERSE_SPEED, motorSim.getSpeed(), TOLERANCE, "Motor should be set to default REVERSE speed.");
    }
